...
/**
 * Problema 44, Estructuras Entrelazadas
 * @author EDg1
 */
public class Problema44Main {
    ...
    public static void main(String[] args) {
        ...
        int pr = esPers.eliminaTodosRepetidosDesordenado();
        ...
        pr = esPers.eliminaTodosRepetidosDesordenado();
