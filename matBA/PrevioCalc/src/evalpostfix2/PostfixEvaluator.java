...
public class PostfixEvaluator {
    ...
    private final static char ADDc = '+';
    private final static char SUBc = '-';
    private final static char MULc = '*';
    private final static char DIVc = '/';
    ...
    */
    public double evaluate (String expre) {
        ...
        String token;
        char sch;
        Scanner parser = new Scanner(expre);
