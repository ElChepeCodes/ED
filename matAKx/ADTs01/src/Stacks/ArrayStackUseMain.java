...
public class ArrayStackUseMain {
    public static void main(String[] args) {
        ...
        System.out.println("\n");        */
        String hola="hola";
        System.out.println("Prueba ejercicio 13:"+"\n");
        System.out.println("Original: "+hola+"\nVolteado: "+Ejercicio13.volteaCadena(hola));
        //Se va a inizializar un ArrayStack y luego agregarle 10 elementos
        ArrayStack<Integer> st = new ArrayStack();
        st.push(1);st.push(2);st.push(3);st.push(4);st.push(5);
        st.push(6);st.push(7);st.push(8);st.push(9);st.push(10);
        System.out.println("\nPrueba ejercicio 14:"+"\n");
        System.out.println("Numero de elementos: "+ejercicio14.cuentaElem(st));
        System.out.println("\nPrueba ejercicio 16:"+"\n");
        System.out.println("Original: "+st.toString());
        System.out.println("\nInvertido: "+Ejercicio16.invierteStack(st).toString());
