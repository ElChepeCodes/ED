...
public class problema29RvMain {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\n4) Posición del mayor valor");
        pos = agD.posMayArrRv(ar, cantValD-1);
        System.out.println("pM. El valor mayor de ar: " + ar[pos] +
                " está en la posicion: " + pos + "\n");

        pos = agI.posMayArrRv(ai, cantValI-1);
        System.out.println("pM. El valor mayor de ai: " + ai[pos] +
                " está en la posicion: " + pos + "\n");
        ...
        ai[3] = -50;
        int val = 38;
        int nelim = agI.elimObjArrRv(ai, cantValI-1, val);
        System.out.println("ai: " + agI.toStringAg(ai, cantValI-1) );
        System.out.println(" Eliminados con " + val + " de ai: " + nelim + "\n");

        val = -50;
        nelim = agI.elimObjArrRv(ai, cantValI-1, val);
        System.out.println("ai: " + agI.toStringAg(ai, cantValI-1) );
        System.out.println(" Eliminados con " + val + " de ai: " + nelim + "\n");
