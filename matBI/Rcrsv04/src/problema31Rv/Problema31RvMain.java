...
public class Problema31RvMain {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Matriz A: " + oma.toStringRenM2d(A, tren, tcol));
        System.out.println("Matriz B: " + oma.toStringRenM2d(B, tren, tcol));
        C = oma.sumaMatrizRenM2(A, B, tren-1, tcol-1);
        System.out.println("C= A + B: " + oma.toStringRenM2d(C, tren, tcol));
        ...
        double [][] Y = { {0.0, 1.0, 2.0, 3.0},    // (2,4)
                          {10.0, 11.0, 12.0, 13.0} };
        System.out.println("Matriz A: " + oma.toStringRenM2d(X, 3, 2));
        System.out.println("Matriz B: " + oma.toStringRenM2d(Y, 2, 4));
        C = oma.multiMatriM2(X, Y);
        System.out.println("C= A + B: " + oma.toStringRenM2d(C, 3, 4));
